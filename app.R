...
server <- function(input, output, session) {
  ...
  colorpal_reactive <- reactive({
    switch(
      ...
      "Anteil SPOE" = pal_spoe,
      "Anteil OEVP" = pal_oevp,
      "Anteil FPOE" = pal_fpoe,
      "Anteil GRUENE" = pal_gruene,
      "Anteil NEOS" = pal_neos,
      "Anteil PILZ" = pal_pilz,
      "Anteil WEISSE" = pal_weisse,
      "Anteil KPOE" = pal_kpoe,
      "Anteil GILT" = pal_gilt,
      "Anteil FLOE" = pal_floe,
      "Wahlbeteiligung" = pal_wahlbet,
      "Ungueltig" = pal_ungueltig,
  ...
  data_reactive <- reactive({
    switch(
      ...
      "Anteil SPOE" = gemeinde@data$a_spoe,
      "Anteil OEVP" = gemeinde@data$a_oevp,
      "Anteil FPOE" = gemeinde@data$a_fpoe,
      "Anteil GRUENE" = gemeinde@data$a_gruene,
      "Anteil NEOS" = gemeinde@data$a_neos,
      "Anteil PILZ" = gemeinde@data$a_pilz,
      "Anteil WEISSE" = gemeinde@data$a_weisse,
      "Anteil KPOE" = gemeinde@data$a_kpoe,
      "Anteil GILT" = gemeinde@data$a_gilt,
      "Anteil FLOE" = gemeinde@data$a_floe,
      "Wahlbeteiligung" = gemeinde@data$wahlbet,
      "Ungueltig" = gemeinde@data$a_unguelti,
